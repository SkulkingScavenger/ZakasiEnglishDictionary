...
var zakasiWords = {
	...
	"karahai": new Word("karahai","1. Hunter, Stalker, Predator, one who hunts 2. the twelfth month of the Gnoll calendar (Hunter’s Moon).",["n."],["hunter","predator","stalker"]),
	...
	"kairash": new Word("kairash","1. blackness 2. the tenth month of the Gnoll calendar (moon of blackness)",["n."],["blackness"]),
	...
	"hazrash": new Word("hazrash","1. Destruction. 2. The sixth month of the Gnoll calendar (Moon of Destruction).",["n."],["destruction"]),
	...
	"yagahash": new Word("yagahash","1. Famine 2. fourth month of the Gnoll calendar (yagahashghu Famine Moon)",["n."],["famine"]),
	...
	"yeegash": new Word("yeegash"," 1. Slumber 2. the eleventh month of the Gnoll calendar (Yeegashghu Moon of Slumber)",["n."],["slumber","sleep"]),
	"yeen": new Word("yeen","From.",["prep."],["from"]),
	"yeenoghu": new Word("yeenoghu"," prop n. The chief Gnoll deity), a war god.",["n."],[""]),
	...
	"zakasi": new Word("zakasi","Gnoll",["n."],["gnoll"]),
	...
	"ragazh": new Word("ragazh"," 1. Rebirth 2. Fifth month of the Gnoll calendar (Ragazhghu Moon of Rebirth)",["n."],["rebirth"]),
	"ragzash": new Word("ragzash"," 1. raider (archaic) 2. first lunar cycle of the Gnoll calender (Raider’s Moon)",["n."],["raider"]),
	...
	"raikeer": new Word("raikeer","1. Storm,  2. The seventh month of the Gnoll calendar (storm moon).",["n."],["storm"]),
	"raithe": new Word("raithe","While.",["prep."],["while"]),
	"ray": new Word("ray","The (Plural) definite article.",["definite article adj."],["the"]),
	"gazasheer": new Word("gazasheer","1. Bone-covered (Archaic) 2.  The third month of the Gnoll calendar (Gazasheerghu Bone Moon)",["adj."],["bone"]),
	...
	"greemheer": new Word("greemheer"," 1. darkness 2. the ninth month of the gnoll calendar (moon of darkness)",["n."],["darkness"]),
	...
	"vahishra": new Word("vahishra"," 1. sanguine (archaic) 2. the second month of the Gnoll calendar",["adj."],["sanguine","bloody"]),
	"vazagash": new Word("vazagash"," 1. Precipitation (archaic) 2. the eighth month of the Gnoll calendar (Moon of Rains)",[""],["rain","precipitation"]),
	...
	"gnollen": new Word("gnollen","Henry Herbert",["n."],["henry"])
};
